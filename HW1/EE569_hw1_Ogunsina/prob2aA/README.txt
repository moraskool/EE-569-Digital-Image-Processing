...
To Run Code :
 	...
 	2. type in g++ -o prob2aA code2a_uniform.cpp
	3. then type in prob2aA.exe <noisy_input_raw> <original_grey_input_raw> <output_raw> <window size> 
 	4. e.g prob2aA.exe Fruit_grey_noisy.raw Fruits_grey.raw output.raw 3
