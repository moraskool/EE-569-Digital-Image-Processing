#  EE569 Homework Assignment Prob 2b, A : Error Diff, Floyd-Steinberg
...
To Run Code :
 	1. Use terminal and navigate to code path = /prob2bA
 	2. type in g++ -o prob2bA prob2bA.cpp
 	3. then prob2bA.exe <input_raw> 
 	4. e.g prob2bA.exe bridge.raw 
