#  EE569 Homework Assignment 2 #Prob 2a B : Random Thresholding 
...
To Run Code :
 	...
 	2. type in g++ -o prob2aB code2aB.cpp
 	3. then prob2aB.exe <input_raw> <output.raw> <image width> <image height>
 	4. e.g prob2aB.exe bridge.raw bridgeRandom.raw 332 501
